    ...
    <section className='flex flex-wrap max-w-8xl justify-evenly'>
      ...
      <div className='flex flex-col gap-12 bg-dark-400 p-8 rounded-lg max-w-xl'>
        ...
        <div className='space-y-6'>
          ...
          <div className='space-y-2'>
            <p> Library ID</p>
            <h1 className='text-xl font-semibold'> {data?.user?.libraryId} </h1>
          </div>

          <div className='space-y-2 max-w-lg'>
            <p> Institution Name </p>
            <h1 className='text-xl font-semibold'> Chittagong University of Engineering and Technology </h1>
          </div>

          <div className='space-y-2'>
            <p> Mobile </p>
            <h1 className='text-xl font-semibold'> 0178882324 </h1>
          </div>

          <div className='space-y-2'>
            <p> Date of Birth </p>
            <h1 className='text-xl font-semibold'> 12/16/1998 </h1>
          </div>
